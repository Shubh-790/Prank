const answers_no = {
    english: [
        "No",
        "Are you sure?",
        "Are you really sure you dont have insect in your Ass??",
        "Are you mother fucking kidding me???",
        "Think again?",
        "I am damn sure you have an insect in your ass?",
        "then why did you click on link?",
        "Maan bhi ja bosdk?",
        "I am not going to ask again!",
        "Ok now this is clear!",
        "tere gand me kira hoga tabhi age click krega!",
        "dekha bola tha na tere gand me kira hai",
        "mja aa gya bosdk!",
        "chal jane de ab prank ni krunga !",
...
function changeLanguage() {
    ...
    if (language === "french") {
        ...
        questionHeading.textContent = "DO you have Insect in your ASS?";
    }
    ...
    if (language === "french") {
        ...
        successMessage.textContent = "Maan gye na bosdk, see you sooonnn :3";
    }
}
